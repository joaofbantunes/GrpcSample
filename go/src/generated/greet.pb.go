...
var fileDescriptor_32c0044392f32579 = []byte{
	...
	0x22, 0x18, 0xd7, 0xa8, 0x82, 0x8b, 0xdd, 0x1d, 0x64, 0x68, 0x6a, 0x91, 0x90, 0x11, 0x17, 0x47,
	0x70, 0x62, 0x25, 0x58, 0x97, 0x90, 0xb0, 0x1e, 0xc4, 0x5e, 0x64, 0x7b, 0xa4, 0x04, 0x51, 0x05,
	0x41, 0x06, 0x5b, 0x72, 0xf1, 0xfa, 0xe4, 0x97, 0x14, 0xfb, 0xa7, 0x81, 0xb8, 0x99, 0xa9, 0xc5,
	0xc4, 0x6a, 0x34, 0x60, 0x74, 0x12, 0x5c, 0xc5, 0xc4, 0xe7, 0x5e, 0x54, 0x90, 0x1c, 0x9c, 0x98,
	0x5b, 0x90, 0x93, 0xaa, 0x17, 0x9e, 0x9a, 0x94, 0xc4, 0x06, 0xf6, 0xa6, 0x31, 0x20, 0x00, 0x00,
	0xff, 0xff, 0x48, 0x9a, 0x39, 0x56, 0xf5, 0x00, 0x00, 0x00,
}
...
func (c *greeterClient) LotsOfReplies(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_LotsOfRepliesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/greet.Greeter/LotsOfReplies", opts...)
	if err != nil {
		return nil, err
	}
